      ...
      <div class="acc-item">
        ...
        <div class="acc-content">
          ...
          <div class="acc-text-wrap">
            ...
            <p>Lorem ipsum dolor sit amet, cons ectetur adipis cing elit, sed do eiusmod tempor incididunt ut labore et
...
============================================================ -->
  <section id="team" aria-label="Our Team">
    <div class="team-grid">
      ...
      <!-- Cell 1: Photo — Member 1 -->
      <div class="team-cell team-photo">
        <img src="team%20images/29.png" alt="Architect portrait" />
      </div>

      <!-- Cell 2: Info — Member 1 -->
      <div class="team-cell team-info">
        <h3 class="team-name">Kavindra Perera</h3>
        <p class="team-role"><span class="team-role-accent">CEO</span> / <span class="team-role-plain">ARCHITECT</span>
        </p>
        <div class="team-socials">
          <a href="#" aria-label="Twitter" class="team-social-icon">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path
                d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L2.25 2.25h6.832l4.258 5.63 5.904-5.63Zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
            </svg>
          </a>
          <a href="#" aria-label="LinkedIn" class="team-social-icon">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path
                d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
            </svg>
          </a>
          <a href="#" aria-label="Facebook" class="team-social-icon">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path
      ...
      <!-- Cell 3: Photo — Member 2 -->
      <div class="team-cell team-photo">
        <img src="team%20images/30.png" alt="Main Contractor portrait" />
      </div>

      <!-- Cell 4: Info — Member 2 -->
      <div class="team-cell team-info">
        <h3 class="team-name">Amaya Silva</h3>
        <p class="team-role"><span class="team-role-accent">MAIN CONTRACTOR</span></p>
        <div class="team-socials">
          <a href="#" aria-label="Twitter" class="team-social-icon">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path
      ...
      <!-- Cell 5: Jobs panel (spans 2 rows) -->
      <div class="team-cell team-jobs" rowspan="2">
        <a href="#" class="team-jobs-link">jobs and internships</a>
      </div>
      ...
      <!-- Cell 7: Info — Member 3 -->
      <div class="team-cell team-info">
        <h3 class="team-name">Dilini Jayawardena</h3>
        <p class="team-role"><span class="team-role-plain">ARCHITECT</span></p>
        <div class="team-socials">
          <a href="#" aria-label="Twitter" class="team-social-icon">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path
      ...
      <!-- Cell 8: Photo — Member 4 -->
      <div class="team-cell team-photo">
        <img src="team%20images/33.png" alt="Product Designer portrait" />
      </div>

      <!-- Cell 9: Info — Member 4 -->
      <div class="team-cell team-info">
        <h3 class="team-name">Ruwan Fernando</h3>
        <p class="team-role"><span class="team-role-plain">PRODUCT DESIGNER</span></p>
        <div class="team-socials">
          <a href="#" aria-label="Twitter" class="team-social-icon">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path
    ...
    <div class="journal-grid">
      ...
      <article class="journal-card journal-card--offset reveal-up" style="--delay:0.12s">
        ...
        <div class="journal-body">
          ...
          <h3 class="journal-post-title">Interior Philosophy And <span class="journal-accent">Creative</span> Vision
          </h3>
        </div>
      </article>
      ...
      <article class="journal-card journal-card--offset reveal-up" style="--delay:0.36s">
        ...
        <div class="journal-body">
          ...
          <h3 class="journal-post-title">Coexisting With The <span class="journal-accent">Landscape</span> Is The Main
            Rule</h3>
        </div>
      </article>
