  ...
  <section id="team" aria-label="Our Team">
    <div class="team-grid">
      ...
      <div class="team-cell team-info">
        ...
        <p class="team-role"><span class="team-role-accent">CEO</span> / <span class="team-role-plain">ARCHITECT</span></p>
        <div class="team-socials">
          <a href="#" aria-label="Twitter" class="team-social-icon">
            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L2.25 2.25h6.832l4.258 5.63 5.904-5.63Zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
