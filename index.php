...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Jost:wght@300;400;500;600;700&family=Inter:wght@300;400;500&display=swap" rel="stylesheet" />
    ...
    <div class="services-grid">
      ...
      <div class="services-panel">
        ...
        <div class="panel-content active" role="tabpanel">
          ...
          <p>From concept sketches to construction documentation, we deliver complete architectural services for residential, commercial, and mixed-use developments. Every design is a thoughtful response to its site, client, and culture.</p>
          <br />
        ...
        <div class="panel-content" role="tabpanel">
          ...
          <p>We design interiors that are a seamless extension of the building itself — where materials, light, proportion, and detail come together to create spaces of genuine comfort and lasting elegance.</p>
          <br />
          <a href="#projects" class="btn btn-dark btn-arrow"><span>See Projects</span></a>
        </div>
        ...
        <div class="panel-content" role="tabpanel">
          ...
          <p>We engage with city makers and communities to develop master plans and urban strategies that are forward-thinking yet deeply rooted in local context — designing the neighbourhoods of tomorrow.</p>
          <br />
          <a href="#projects" class="btn btn-dark btn-arrow"><span>See Projects</span></a>
        </div>
        ...
        <div class="panel-content" role="tabpanel">
          ...
          <p>Our landscape team creates outdoor environments that enhance the architecture and enrich the lives of those who inhabit them — from private gardens to large-scale public realm projects.</p>
          <br />
          <a href="#projects" class="btn btn-dark btn-arrow"><span>See Projects</span></a>
        </div>
